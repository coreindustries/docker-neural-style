...
nvidia-docker run -i -v /mnt/raid/projects:/projects -t coreindustries/neuralstyle:latest -gpu 1 -style_image examples/inputs/starry_night.jpg -content_image examples/inputs/hoovertowernight.jpg